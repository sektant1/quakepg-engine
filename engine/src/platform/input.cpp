...
{
    return s_keys_current[(u32)k];
}

bool input_key_pressed(Key k)
{
    return s_keys_current[(u32)k] && !s_keys_previous[(u32)k];
}

bool input_key_released(Key k)
{
    return !s_keys_current[(u32)k] && s_keys_previous[(u32)k];
}
...
{
    return s_mouse_current[(u32)b];
}

bool input_mouse_pressed(MouseButton b)
{
    return s_mouse_current[(u32)b] && !s_mouse_previous[(u32)b];
}
